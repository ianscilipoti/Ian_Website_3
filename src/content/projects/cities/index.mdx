...
<ProjectImage src={fullCityImg} alt="A top down view of a city with placeholder buildings." />
...
<ProjectImage src={subdivisionImg} alt="Multiple Subdivision levels" />
...
This recursive structure allows for detailed layouts to be programmed. For example, high level regions can be assigned qualities such as socioeconomic status, business vs residential, etc. These properties can be used to decide what types of road structures, parks, etc will be chosen in future subdivisions.
...
<ProjectImage src={roadviewImg} alt="A view from a road near a park" />
